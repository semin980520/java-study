...
//        AbstractAnimal a1 = new AbstractAnimal();
        ...
        AbstractAnimalDog d1 = new AbstractAnimalDog();
        d1.makeSound1();
        d1.makeSound2();
...
// 클래스에 추상메서드가 하나라도 있으면 이 클래스는 추상클래스가 되고,
// 클래스 앞에 abstract키워드가 붙음.
abstract class AbstractAnimal {

    void makeSound1(){
        System.out.println("동물은 소리를 냅니다.");
    }
//    abstract(추상)메서드는 선언만하고 구현이 없는 메서드
//    해당 클래스를 상속받는 클래스에서 abstract메서드 구현
    abstract void makeSound2();

    }

class AbstractAnimalDog extends AbstractAnimal{
...
//final 키워드를 통해 상속 불가한 클래스로 변경 할 수 있다.
