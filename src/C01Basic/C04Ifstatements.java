...
//            System.out.println("걸어가시오");
//        }
//        삼항연산자 : 결과값 = 조건식? 번환값1 : 반환값2
//        String answer = "1234";
//        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
//        String input = br.readLine();
//        String result = answer.equals(input) ? "문이열렸습니다" : "비밀번호가 틀렸습니다.";
//        System.out.println(result);

//        switch문 : if, else if, else if 등 여러보건식이 있을때 조건문을 가독성있게 표현한 구문
//        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
//        int input = Integer.parseInt(br.readLine());
//        input과 case의 값들을 equal관계이고, 구문마다 반드시 break를 넣어줘야함
