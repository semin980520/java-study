...
//////          변수의 명명규칙
////            변수명에 읨의 분절이 일어나는 경우에는 camelase 또는 _ 사용
////            String myFirstName = "hongildong";
////            String my_frist_name = "hongildong";
//
////        정수 : byte(1바이트), int(4바이트), long(8바이트)
////        byte a = 127;
////        byte b = -128;
////
//////      자료형이 표현할 수 있는 범위를 넘어선경우 오버플로우/언더플로우 발생
//////        오버플로우
////            a++;
...
////
//////        소수점 연산 오차 해결방벙1 : 소수를 정수로 변환 후 추후 다시 나눗셈으로 변환
////        double total2 = 0;
////        for (int i = 0; i < 1000; i++) {
////            total2 += (0.1 * 10);
////        }
