...
//            }
//        };
////        인터페이스의 익명객체에 구현해야 할 메서드가 1개밖에 없을때에는
////        람다표현식(화살표함수) 사용가능
//        Animal2 a2_1 = () -> {
...
//        Animal2 a2_2 = () -> System.out.println("hello world2 ");
//
//        a2_2.makeSound();
...
//        익명객체 생성시 메서드의 기능: 매개변수의 숫자값이 10이상이면 a+b리턴, 10미만이면 a만 리턴
        ...
        System.out.println(a4.makeSound("1","2",4));
        }
